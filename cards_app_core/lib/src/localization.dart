...
class ArchSampleLocalizations {
  ...
  String get newCardHint => Intl.message(
  ...
  String get addCard => Intl.message(
        'Add Card',
        name: 'addCard',
        args: [],
        locale: locale.toString(),
  ...
  String get editCard => Intl.message(
        'Edit Card',
        name: 'editCard',
        args: [],
        locale: locale.toString(),
  ...
  String get filterCards => Intl.message(
        'Filter Cards',
        name: 'filterCards',
        args: [],
        locale: locale.toString(),
  ...
  String get deleteCard => Intl.message(
        'Delete Card',
        name: 'deleteCard',
        args: [],
        locale: locale.toString(),
  ...
  String get emptyCardError => Intl.message(
  ...
  String get completedCards => Intl.message(
        'Completed Cards',
        name: 'completedCards',
        args: [],
        locale: locale.toString(),
  ...
  String get activeCards => Intl.message(
        'Active Cards',
        name: 'activeCards',
        args: [],
        locale: locale.toString(),
  ...
  String cardDeleted(String task) => Intl.message(
        'Deleted "$task"',
        name: 'cardDeleted',
        args: [task],
        locale: locale.toString(),
  ...
  String get deleteCardConfirmation => Intl.message(
        'Delete this card?',
        name: 'deleteCardConfirmation',
        args: [],
        locale: locale.toString(),
      );
