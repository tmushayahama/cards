...
import 'card_item_element.dart';

class CardListElement extends TestElement {
  final _cardListFinder = find.byValueKey('__cardList__');
  final _loadingFinder = find.byValueKey('__cardsLoading__');

  CardListElement(FlutterDriver driver) : super(driver);
  ...
  Future<bool> get isReady => widgetExists(driver, _cardListFinder);

  CardItemElement cardItem(String id) => new CardItemElement(id, driver);

  CardItemElement cardItemAbsent(String id) => new CardItemElement(id, driver);
}
